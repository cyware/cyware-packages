...
clean() {
    ...
    # Clean the files
    rm -rf ${DOCKERFILE_PATH}/{*.sh,*.tar.gz,cyware-*} ${SOURCES_DIRECTORY}
...
help() {
    ...
    echo "    --packages-branch <branch>    [Required] Select Git branch or tag from cyware-packages repository. e.g ${PACKAGES_BRANCH}"
