...
# Program to build the Cyware App for Splunk
...
BRANCH_TAG=""
SPLUNK_VERSION=""
CONTAINER_NAME="cyware-splunk-app-builder"
OUTDIR="${CURRENT_PATH}/output"
CHECKSUMDIR=""
REVISION=""
REPOSITORY="cyware-splunk"
...
build_package() {
    ...
    docker run -t --rm -v ${OUTDIR}:/cyware_splunk_app:Z \
