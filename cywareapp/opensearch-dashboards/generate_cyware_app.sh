...
# Program to build the Cyware App for OpenSearch Dashboards
...
BRANCH_TAG=""
CHECKSUMDIR=""
CONTAINER_NAME="cyware-plugin-for-opensearch-dashboards-builder"
...
help() {
    ...
    echo "    -s, --store <path>        [Optional] Set the destination path of package, by default /tmp/cyware-app."
...
build_package(){
    ...
    # Build the Cyware plugin for OpenSearch Dashboards package using the build docker image
    docker run --rm -t -v "${OUTDIR}":/cyware_app:Z \
