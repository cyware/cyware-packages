Automated Cyware Solaris packages using vagrant
==============================================

In this repository, you can find the necessary tools to build a Cyware package for Solaris 10 and 11 using vagrant.
...
1. Download this repository, copy the `solaris10` or `solaris11` directory into `package_generation/src` and go to the `package_generation` directory:
    ```bash
    $ git clone https://github.com/cyware/cyware-packages
    $ cp -r cyware-packages/solaris/solaris10 cyware-packages/solaris/package_generation/src
    $ cd cyware-packages/solaris/package_generation
    ```
...
2. Bring the machine up `vagrant [OPTION] ... up solaris10/solaris11`:
    ...
    ```
    * To build a cyware-agent package for Solaris 10 from branch v3.9.0 sources:
