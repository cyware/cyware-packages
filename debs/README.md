...
In this repository, you can find the necessary tools to build a Cyware package for Debian based OS.

## Building DEB packages

Please, visit the following link for the full DEB packages building documentation: [Generate Cyware Debian packages.](https://documentation.cyware.khulnasoft.com/current/development/packaging/generate-deb-package.html)
