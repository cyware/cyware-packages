...
base_dir=/opt/cyware-dashboard-base
...
# Including files
if [ "${reference}" ];then
    curl -sL https://github.com/cyware/cyware-packages/tarball/"${reference}" | tar xz
    cp -r ./cyware*/* /root/
...
cyware_minor=$(echo ${version} | cut -c1-3)

# Obtain the Cyware plugin URL
if [ "${repository}" ];then
...
# -----------------------------------------------------------------------------
# Customize OpenSearch Dashboards with Cyware
# -----------------------------------------------------------------------------

# Replace App Title
sed -i "s|defaultValue: ''|defaultValue: \'Cyware\'|g" ./src/core/server/opensearch_dashboards_config.js
...
sed -i 's|OpenSearch Dashboards documentation|Cyware documentation|' ./src/core/target/public/core.entry.js
sed -i 's|href:opensearchDashboardsDocLink,|href:"https://documentation.cyware.khulnasoft.com/'${cyware_minor}'",|' ./src/core/target/public/core.entry.js
## Help link - Ask OpenSearch
sed -i 's|Ask OpenSearch|Ask Cyware|' ./src/core/target/public/core.entry.js
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://github.com/opensearch-project"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./src/core/target/public/core.entry.js
## Help link - Community
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://forum.opensearch.org/"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./src/core/target/public/core.entry.js
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://forum.opensearch.org/"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./plugins/alertingDashboards/target/public/alertingDashboards.plugin.js
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://forum.opensearch.org/"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./plugins/indexManagementDashboards/target/public/indexManagementDashboards.plugin.js
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://forum.opensearch.org/"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./plugins/notificationsDashboards/target/public/notificationsDashboards.plugin.js
sed -i 's|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://forum.opensearch.org/"|OPENSEARCH_DASHBOARDS_ASK_OPENSEARCH_LINK="https://cyware.khulnasoft.com/community/join-us-on-slack"|' ./plugins/securityDashboards/target/public/securityDashboards.plugin.js
## Help link - Give feedback
sed -i 's|https://survey.opensearch.org|https://cyware.khulnasoft.com/community/join-us-on-slack|' src/core/server/opensearch_dashboards_config.js
## Help link - Open an issue in GitHub
sed -i 's|GITHUB_CREATE_ISSUE_LINK="https://github.com/opensearch-project/OpenSearch-Dashboards/issues/new/choose"|GITHUB_CREATE_ISSUE_LINK="https://github.com/cyware/cyware/issues/new/choose"|' ./src/core/target/public/core.entry.js
...
sed -i 's|OPENSEARCH_ON_LIGHT="ui/logos/opensearch_on_light.svg"|OPENSEARCH_ON_LIGHT="ui/logos/Cyware-Logo.svg"|g' ./plugins/alertingDashboards/target/public/alertingDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_DARK="ui/logos/opensearch_on_dark.svg"|OPENSEARCH_ON_DARK="ui/logos/Cyware-Logo.svg"|g' ./plugins/alertingDashboards/target/public/alertingDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_LIGHT="ui/logos/opensearch_on_light.svg"|OPENSEARCH_ON_LIGHT="ui/logos/Cyware-Logo.svg"|g' ./plugins/indexManagementDashboards/target/public/indexManagementDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_DARK="ui/logos/opensearch_on_dark.svg"|OPENSEARCH_ON_DARK="ui/logos/Cyware-Logo.svg"|g' ./plugins/indexManagementDashboards/target/public/indexManagementDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_LIGHT="ui/logos/opensearch_on_light.svg"|OPENSEARCH_ON_LIGHT="ui/logos/Cyware-Logo.svg"|g' ./plugins/notificationsDashboards/target/public/notificationsDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_DARK="ui/logos/opensearch_on_dark.svg"|OPENSEARCH_ON_DARK="ui/logos/Cyware-Logo.svg"|g' ./plugins/notificationsDashboards/target/public/notificationsDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_LIGHT="ui/logos/opensearch_on_light.svg"|OPENSEARCH_ON_LIGHT="ui/logos/Cyware-Logo.svg"|g' ./plugins/securityDashboards/target/public/securityDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_DARK="ui/logos/opensearch_on_dark.svg"|OPENSEARCH_ON_DARK="ui/logos/Cyware-Logo.svg"|g' ./plugins/securityDashboards/target/public/securityDashboards.plugin.js
sed -i 's|OPENSEARCH_ON_LIGHT="ui/logos/opensearch_on_light.svg"|OPENSEARCH_ON_LIGHT="ui/logos/Cyware-Logo.svg"|g' ./src/core/target/public/core.entry.js
sed -i 's|OPENSEARCH_ON_DARK="ui/logos/opensearch_on_dark.svg"|OPENSEARCH_ON_DARK="ui/logos/Cyware-Logo.svg"|g' ./src/core/target/public/core.entry.js
...
# -----------------------------------------------------------------------------
# Cyware customizations
# -----------------------------------------------------------------------------

# Add VERSION file
cp /root/VERSION .

# Add an exception for cyware plugin install
cyware_plugin="if (plugin.includes(\'cyware\')) {\n    return plugin;\n  } else {\n    return \`\${LATEST_PLUGIN_BASE_URL}\/\${version}\/latest\/\${platform}\/\${arch}\/tar\/builds\/opensearch-dashboards\/plugins\/\${plugin}-\${version}.zip\`;\n  }"
sed -i "s|return \`\${LATEST_PLUGIN_BASE_URL}\/\${version}\/latest\/\${platform}\/\${arch}\/tar\/builds\/opensearch-dashboards\/plugins\/\${plugin}-\${version}.zip\`;|$cyware_plugin|" ./src/cli_plugin/install/settings.js

# Generate build number for package.json
curl -sO ${url}
unzip *.zip 'opensearch-dashboards/cyware/package.json'
build_number=$(jq -r '.version' ./opensearch-dashboards/cyware/package.json | tr -d '.')$(jq -r '.revision' ./opensearch-dashboards/cyware/package.json)
...
# Base output
cd /opt
tar -cJf cyware-dashboard-base-"${version}"-"${revision}"-linux-${architecture}.tar.xz cyware-dashboard-base
cp cyware-dashboard-base-"${version}"-"${revision}"-linux-${architecture}.tar.xz /tmp/output/
